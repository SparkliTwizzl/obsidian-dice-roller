...
class LexerClass {
    ...
    isRollAliasingEnabled: boolean = false;
    ...
    #buildLexer() {
        ...
        if (this.isRollAliasingEnabled) {
            rules.rollAlias = {
                match: ROLL_ALIAS_REGEX,
                value: (match: string) => {
                    return match
    ...
    public setEnableRollAliasing(enabled: boolean) {
        this.isRollAliasingEnabled = enabled;
        this.#buildLexer();
    }
